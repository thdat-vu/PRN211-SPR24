namespace Zodiac
{
    ...
    /// <summary>
    /// This class contains methods to return the Zodiac Sign based on the 
    ...
    public class ZodiacCalculator
    {
        ...
        /// <summary>
        /// This method returns the Zodiac Sign based on the day and the month of birth.
        /// </summary>
        /// <param name="day">Day must be between 1..31</param>
        /// <param name="month">Month must be between 1..12</param>
        /// <returns></returns>
        public static string GetZodiacEnglish(int day, int month)
        {
            switch (month)
            {
                case 1: //Jan
